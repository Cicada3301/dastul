define(['blocks', 'mathUtils'], function(Blocks, mathUtils){
        ...
        generate:function(world){
            ...
            for(var col=0; col<world.width; ++col) {
                for (var row = 0; row < terrain.worldPoints[col]; ++row) {
                    ...
                    if (terrain.worldPoints[col] - row < dirtLayer) world.cells[col][row] = new Blocks.dirt.gen(col, row);
    ...
    basicLayers.Terrain.prototype.generate=function(start, end, maxElevation){
        ...
        this.world.cells[middle][newY+ this.world.generation.terrain.seaLevel]=new Blocks.grass.gen(middle, newY+this.world.generation.terrain.seaLevel);
